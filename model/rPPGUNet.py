...
class Decoder(nn.Module):
    def __init__(self, in_c, out_c):
        ...
        self.decoder = nn.Sequential(
            # 普通卷积
            nn.Conv1d(in_channels=in_c * 2, out_channels=in_c, kernel_size=1, stride=1, padding=0),
            nn.BatchNorm1d(in_c),
            nn.ReLU(),
            nn.Conv1d(in_channels=in_c, out_channels=out_c, kernel_size=1, stride=1, padding=0),
