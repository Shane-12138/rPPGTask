...
class FusionBlock(nn.Module):
    ...
    def forward(self, x_res, x_attn):
        ...
        x_max = self.maxPool(x_all)
        x_avg = self.avgPool(x_all)
        y = self.conv(x_max + x_avg + x_all)
...
class rPPGTRPaper(nn.Module):
    def __init__(self):
        super(rPPGTRPaper, self).__init__()
    ...
    def forward(self, video):
        ...
        # output_cnn = self.mlp_out(output_cnn)
